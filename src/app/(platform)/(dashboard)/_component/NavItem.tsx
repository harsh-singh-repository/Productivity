...
const NavItem = ({isExpanded,isActive,organization,onExpand}:NavItemProp) => {
  ...
  return (
    <>
      <AccordionItem value={organization.id} className="border-none">
           <AccordionTrigger onClick={()=>onExpand(organization.id)} className={cn("flex item-center gap-x-2 p-1.5 text-neutral-700 rounded-md hover:bg-neutral-500 transition text-start no-underline hover:no-underline", isActive && !isExpanded && "bg-green-500/10 text-green-700")}>
